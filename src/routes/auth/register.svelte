        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 col-xs-12">
                ...
                <form on:submit|preventDefault={submit}>
                    ...
                    <fieldset class="form-group">
                        <input class="form-control form-control-lg" type="text" required placeholder="Email" bind:value={email}>
                    </fieldset>
                    <fieldset class="form-group">
                        <input class="form-control form-control-lg" type="password" required placeholder="Password" bind:value={password}>
                        {#if password.length > 0 && password.length < 7}<sup><div class="alert-danger" role="alert">Password is too short</div></sup>{/if}
                    </fieldset>
